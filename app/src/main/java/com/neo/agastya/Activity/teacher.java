...
//                Toast.makeText(LoginActivity.this, " Fill the Fields", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    URL url = new URL("https://neoinfotech.com/neoerp/agastya/api/login.php?username=" + checkusername + "&password=" + checkpassword);
                    ...
                    singleParsed = (String) jObject.get("login_id");
                    Storeuser = (String) jObject.get("company_id");
...
//                    WriteFile(e);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (message.equals("Welcome !!")) {
                dbHelper.insertData(Storeuser,singleParsed);
                Intent i=new Intent(teacher.this,Student_details.class);
                i.putExtra("user",""+Storeuser);
                startActivity(i);
            }else{
                Toast.makeText(teacher.this, ""+message, Toast.LENGTH_SHORT).show();
            }
