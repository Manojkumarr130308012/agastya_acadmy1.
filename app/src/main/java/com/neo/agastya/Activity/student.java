...
//                Toast.makeText(LoginActivity.this, " Fill the Fields", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    URL url = new URL("https://gasvalley.in/erp/api/login.php?username="+checkusername+"&password="+checkpassword);
                    ...
                    JSONObject jObject = jsonobj.getJSONObject("login");
...
//                        pbar.setVisibility(View.INVISIBLE);
                ...
                Intent i=new Intent(student.this,Student_details.class);
